    ...
    switch($page) { //suivant l'action à réaliser, on affiche pas tous les liens
        case 'none': //si l'utilisateur n'a pas encore choisi d'action particulière, on affiche tout
            ?>
                ...
                <a href="index.php?controleur=statistiques&action=statRegion" >
                    Afficher les statistiques par région
                </a>
                &mdash;
                &mdash;
                <a href="index.php?controleur=statistiques&action=delegues" >
                    Afficher tous les délégués
                </a>
                &mdash;
                &mdash;
                <a href="index.php?controleur=statistiques&action=statSecteur" >
