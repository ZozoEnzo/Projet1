<?php
	...
	*/
    class Region {
		...
		//Les getters et setters de la classe region avec le codeRegion, le nomRegion, et le codeSecteur.
		...
		//La fonction qui permet de récupérer la liste de toutes les régions avec une requête sql, et de retourner dans un tableau ces régions.
